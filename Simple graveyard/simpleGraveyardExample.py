...
client_id = os.getenv("CLIENT_ID_GRAVEYARD_SIMPLE")  # API name provided by KA
client_secret = os.getenv("CLIENT_SECRET_GRAVEYARD_SIMPLE")  # API password provided by KA
...
folder_name = datetime.now().strftime("results/simple_graveyards")
os.makedirs(folder_name, exist_ok=True)

# Write the data to a JSON file
output_file = os.path.join(folder_name, "simple_graveyards.json")
